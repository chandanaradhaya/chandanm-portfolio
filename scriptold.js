        ...
        case "intro":
            setTimeout(() => {
                sendTextMessage(
                    ...
                    "As an engineer, I am eager to learn new skills and explore trending domains in the field of computer science, which helps enhance my knowledge and abilities.<br><br>" +
...
//            sendTextMessage("<span class='sk'>Send coloured keyword to get what you want to know about me...<br>e.g<br>📍<span class='bold'>skills</span> - to know my skills<br>📍<span class='bold'>resume</span> - to get my resume<br>📍<span class='bold'>education</span> - to get my education details<br>📍<span class='bold'>address</span> - to get my address<br>📍<span class='bold'>contact</span> - to get ways to connect with me<br>📍<span class='bold'>projects</span> - to get details of my projects<br>📍<span class='bold'>about</span> - to know about this site<br>📍<span class='bold'>clear</span> - to clear conversation</span>");
        ...
        case "skills":
            sendTextMessage(
                ...
                "Android Studio<br>VS Code<br>IntelliJ IDEA<br>Graph Sandbox<br>Neo4j Bloom / Browser<br>Findwise I3<br>Postman</span><br>" +
                "</span>"
            );
            break;
        ...
        case "education":
            sendTextMessage(
                ...
                "Sai Vidya Institute of Technology, Bengaluru<br>" +
                "Pass-out Year: 2024<br>" +
                "CGPA: 8.8<br><br>" +

                "🌟 <span class='bold'>12th / PUC (PCMB)</span><br>" +
                "Vidyanidhi PU College, Tumkur<br>" +
                "Pass-out Year: 2020<br>" +
                "Percentage: 88%<br><br>" +

                "🌟 <span class='bold'>10th / SSLC</span><br>" +
                "Nalanda High School, Doddaballapur<br>" +
        ...
        case "projects":
            sendTextMessage(
                "Want to check out my projects? Visit my GitHub profile using the link below:<br><br>" +
        ...
        case "awards":
            sendTextMessage(
                "Do you want to check my awards, certifications and patents? Then visit them on my LinkedIn profile. Here is the link:<br><br>" +
        ...
        default:
            setTimeout(() => {
                sendTextMessage("Hey I couldn't catch you...😢<br>Send 'Hi' to know more about me.");
            }, 500);
            break;
    }
}
